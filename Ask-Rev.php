...
function plugTSS_check_installation_date() {
    ...
    $nobug = "";
    $nobug = sanitize_text_field(get_option('plugTSS_hide_noticeSec2'));
...
function plugTSS_display_admin_notice() {
    ...
    $install_date = sanitize_text_field(get_option( 'plugTSS_activation_date' ));
 
    echo '<div class="psprev-adm-notice psprev-adm-notice-wp-rating notice">';

    echo '<div style="width:65%; display: inline-block;" ><br> <h3><b>' . __( 'Do You Like Testimonial Slider ? You\'ll Love our Login Page Customizer! ', 'tss' ) . '</b></h3>';
...
function plugTSS_set_no_bug() {
    ...
    if ( 1 == $nobug ) {
        ...
        add_option( 'plugTSS_hide_noticeSec2', TRUE );
    }
