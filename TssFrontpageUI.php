...
<style type="text/css">
	...
	.ub-heading-bar{
		...
		<div id='sec_right'>
				...
				<p><b>Form Builder Plugin - <?php echo esc_attr($ulp_install_link); ?></p>
				<img src="<?php echo plugins_url('imgs/msf.png',__FILE__); ?>" class="rc_plugin_thumb">
				<p>Subscribe Form Plugin - <?php echo esc_attr($msfp_install_link); ?></p>
				<img src="<?php echo plugins_url('imgs/psp.png',__FILE__); ?>" class="rc_plugin_thumb">
				<p>Posts Slider Plugin (Free) - <?php echo esc_attr($pss_install_link); ?></p>
