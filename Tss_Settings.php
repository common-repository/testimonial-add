...
function tss_form_options_set_to_head(){
 // $option = get_option('some option');
  ...
  //SLider 
  $tss_post_testimonial_message = sanitize_text_field(get_option('tss_post_testimonial_message'));
  $tss_testimonial_type = sanitize_text_field(get_option('tss_testimonial_type'));
