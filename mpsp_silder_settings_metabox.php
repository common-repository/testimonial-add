...
function tss_mpsp_slider_settings($post){
 ...
 //////////////////////////////////////////////////////////////////////////
    ...
    $mpsp_posts_bg_color = esc_attr( get_post_meta($post->ID,'mpsp_posts_bg_color',true) );
    $mpsp_posts_heading_color = esc_attr( get_post_meta($post->ID,'mpsp_posts_heading_color',true) );
    $mpsp_posts_description_color = esc_attr( get_post_meta($post->ID,'mpsp_posts_description_color',true) );
    $mpsp_slide_speed = esc_attr( get_post_meta($post->ID,'mpsp_slide_speed',true) );
    $mpsp_slide_transistion = esc_attr( get_post_meta($post->ID,'mpsp_slide_transistion',true) );
    $mpsp_slide_single = esc_attr( get_post_meta($post->ID,'mpsp_slide_single',true) );
    $mpsp_slide_autoplay = esc_attr( get_post_meta($post->ID,'mpsp_slide_autoplay',true) );
    $mpsp_slide_pagination = esc_attr( get_post_meta($post->ID,'mpsp_slide_pagination',true) );
    $mpsp_slide_pagination_numbers = esc_attr( get_post_meta($post->ID,'mpsp_slide_pagination_numbers',true) );
    $mpsp_slide_main_head_bar = esc_attr( get_post_meta($post->ID,'mpsp_slide_main_head_bar',true) );
    $mpsp_slide_main_heading = esc_attr( get_post_meta($post->ID,'mpsp_slide_main_heading',true) );
    $mpsp_slide_navigation = esc_attr( get_post_meta($post->ID,'mpsp_slide_navigation',true) );
    $mpsp_slide_nav_button_position = esc_attr( get_post_meta($post->ID,'mpsp_slide_nav_button_position',true) );
    $mpsp_slide_nav_button_color = esc_attr( get_post_meta($post->ID,'mpsp_slide_nav_button_color',true) );
    $mpsp_slide_custom_width = esc_attr( get_post_meta($post->ID,'mpsp_slide_custom_width',true) );
    $mpsp_slider_id = esc_attr( get_post_meta($post->ID,'mpsp_slider_id',true) );
    $tss_mpsp_slider_img_border = esc_attr( get_post_meta($post->ID,'tss_mpsp_slider_img_border',true) );
    $mpsp_postid = $post->ID;
    ...
    <input type='hidden' name='mpsp_slider_id' value='<?php echo esc_attr($mpsp_postid); ?>'>
      ...
      <input type="text" class='tss-color-picker' name="mpsp_posts_bg_color" value="<?php echo esc_attr($mpsp_posts_bg_color); ?>">
      <br>
      <br>
     
    <label for="mpsp_posts_description_color">Text Color :</label>
      <input type="text" class='tss-color-picker' name="mpsp_posts_description_color" value="<?php echo esc_attr($mpsp_posts_description_color); ?>">
      ...
      <input type="number" name="mpsp_slide_speed" value="<?php echo esc_attr($mpsp_slide_speed); ?>" placeholder="200" required='required'>
...
<?php selected( "'fadeUp'", $mpsp_slide_transistion ); ?>
     ...
     <br>
      ...
      <input type="number" placeholder="Number of testimonials" name="mpsp_slide_single" value="<?php echo esc_attr($mpsp_slide_single); ?>" style="width:190px;" min="1" max="4" required='required' >
...
<?php selected( "<style type='text/css'> .owl-buttons{ text-align:left; }</style>", $mpsp_slide_nav_button_position ); ?>
      ...
      <input type="text" class='tss-color-picker' name="mpsp_slide_nav_button_color" value="<?php echo esc_attr($mpsp_slide_nav_button_color); ?>">
      <br>
      <br>
