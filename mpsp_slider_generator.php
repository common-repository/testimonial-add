...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ffffff', endColorstr='#e5e5e5',GradientType=0 );
 ...
 height:;    display:<?php echo esc_attr( get_post_meta($id,'mpsp_slide_main_head_bar',true) ); ?>;  border-radius:3px;">
     <?php echo esc_attr( get_post_meta($id,'mpsp_slide_main_heading',true) ); ?>
   </h2> 
...
$mpsp_posts_key = esc_attr( get_post_meta($id,'mpsp_posts_key',true) );
...
<div id='tss_warppper'>
  <div id='tss_content'>
    <img id='tss_image' src="<?php echo esc_attr( get_post_meta(get_the_ID(),'tss_image',true) );  ?>">
    ...
    <p class='tss_p' id='tss_testimonial'><span>"</span><?php echo esc_attr( get_post_meta(get_the_ID(),'tss_testimonial',true) );  ?><span>"</span></p>
  </div>  
</div>
...
<?php endwhile;?>
         ...
         jQuery("#owl-demo").owlCarousel({
              ...
              goToFirstSpeed : 2000,
              singleItem : <?php echo  esc_attr( get_post_meta($id,'mpsp_slide_single',true) ); ?>,
              autoHeight : true,
